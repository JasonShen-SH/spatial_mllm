...
echo "本脚本针对box+point的训练, 默认环境和数据已经配置完毕, 若没有, 请将下面注释内容恢复"
...
# echo "请注意: 由于是需要验证的Onedrive链接, 您需要手动下载ReVOS数据集至/home/volume_shared/share_datasets/video_datas/ReVOS/, 下载链接为:"
...
echo "请确保安装README.md的指示, 修改projects/llava_sam2/configs/sa2va_8b_point.py中的数据路径配置"

# echo "请确保从百度网盘下载空间位置关系数据集, 并存储在/home/volume_shared/share_datasets/video_datas/all_vos2/"

# echo "准备工作完成后，使用以下命令开始训练："

echo "CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash tools/dist.sh train projects/llava_sam2/configs/sa2va_8b_point.py 8 --work-dir spatial_mllm_with_point_save"