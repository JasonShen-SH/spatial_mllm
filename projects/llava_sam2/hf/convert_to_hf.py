...
def parse_args():
    ...
    parser.add_argument('--config', default='projects/llava_sam2/configs/sa2va_8b_spatial.py')
    parser.add_argument('--pth_model', default='debug_spatial_refcoco_mevis_refytvos_relative_absolute_switch/iter_49300.pth')
    parser.add_argument('--save-path', default='work_dirs/hf_model_spatial_refcoco_mevis_refytvos_relative_absolute_switch')
